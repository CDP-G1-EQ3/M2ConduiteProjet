...
|03 | En tant qu'utilisateur, je souhaite accéder à une liste de mes projets contenant les champs nom du projet, description courte et propriétaire du projet afin de visualiser les projets auxquels je participe. |  | 2 | Ouverte |
...
| 06 | En tant qu'utilisateur je souhaite cliquer sur un élément de la liste de projets auxquels je participe afin d'accéder à la page de ce projet. |  | 1 | Ouverte |
...
|08 | En tant que membre d'un projet, je souhaite pouvoir consulter la page d'un projet afin d'accéder aux différents onglets proposés et travailler dessus. |  | 3 | Ouverte |
...
|14 | En tant que membre d'un projet, je souhaite remplir les champs type (nouvelle fonctionnalité, correction de bug, amélioration de performance, refactoring/amélioration du code), importance (minimale, normale ou maximale) et difficulté d'une US afin de la qualifier (une US ne sera qualifiée que lorsque ces trois champs seront complétés). | | 2 | Ouverte |
